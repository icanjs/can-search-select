# Contributing to can-search-select

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/icanjs/can-search-select) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-search-select, you can start by going to its [fork page](https://github.com/icanjs/can-search-select/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-search-select
```
